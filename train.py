...
#from dataSeg import v2, v1, VOCSegmentation, VOCroot, VOC_CLASSES, BaseTransform, detection_collate
...
def train():
    ...
    #dataset = VOCSegmentation(args.voc_root, train_sets, BaseTransform(300, means))
